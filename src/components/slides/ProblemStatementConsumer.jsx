  ...
  return (
    <div className="w-full h-full relative grid grid-cols-1 lg:grid-cols-12 bg-[#FCFCFA] select-none overflow-hidden">
      ...
      <div className="lg:col-span-7 flex flex-col justify-center pl-10 md:pl-16 pr-8 relative z-10 py-10">
        ...
        <h2 className="text-3xl md:text-[28px] font-extrabold font-title text-slate-900 tracking-tight leading-tight mb-6">
      ...
      <div className="lg:col-span-5 bg-slate-50/20 border-l border-slate-200/40 flex flex-col justify-center items-center relative z-10 py-10 px-8 select-none">
